...
public class CommonUtil {
    ...
    public Boolean sendMail(String url,String recipentEmail) throws UnsupportedEncodingException, MessagingException{
        ...
        helper.setFrom("sajidsayyed998@gmail.com","Shopping Cart");
        helper.setTo(recipentEmail);

        String content = "<p>Hello,</p>" + "<p>You have requested to reset your password.<p/>"+"<p>Click the link below to change your password:</p>"+"<p><a href=\"" + url +
    ...
    public Boolean sendMailForProductOrder(ProductOrder order,String status) throws Exception
    {
        ...
        helper.setFrom("sajidsayyed998@gmail.com","Shopping_Cart");
