...
public class HomeController {
    ...
    public String index(Model m) {
        List<Category> allActiveCategory = categoryService.getAllActiveCatgeory().stream()
    ...
    public String products(Model m, @RequestParam(value = "category", defaultValue = "") String category,
        ...
        List<Category> categories = categoryService.getAllActiveCatgeory();
    ...
    public String processForgotPassword(@RequestParam String email, HttpSession session, HttpServletRequest  request) throws UnsupportedEncodingException, MessagingException
    {
        ...
        else
        {
            ...
            Boolean sendEnail = commonUtil.sendMail(url,email);
